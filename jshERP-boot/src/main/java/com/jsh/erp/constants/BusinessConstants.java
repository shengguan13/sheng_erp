...
public class BusinessConstants {
    ...
    public static final String SUB_TYPE_REPAIR_OUT = "返修出库";
    public static final String SUB_TYPE_REPAIR_IN = "返修入库";
     ...
     * */
    //session的生命周期,秒
    public static final Long MAX_SESSION_IN_SECONDS= 10 * 60 * 60L;
}
