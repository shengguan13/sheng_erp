      ...
      return {
        ...
        accountTable: {
          ...
          columns: [
            ...
            { title: '应付金额',key: 'needDebt', width: '10%', type: FormTypes.inputNumber, statistics: true, readonly: true },
            { title: '实际付款',key: 'finishDebt', width: '10%', type: FormTypes.inputNumber, statistics: true, placeholder: '请输入${title}',
