    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          返修出库指的是将产品从隔离库中取出进行返修。
          <a-tooltip placement="left" title="返修出库指的是将产品从隔离库中取出进行返修。" slot="action">
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '返修出库', prefixNo)">查看</a>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          importExcelUrl: "/depotHead/importRepairOutExcel"
        }
      }
    },
    computed: {
    ...
    methods: {
      handleImportXls() {
        ...
        let templateName = '返修出库Excel模板[下载]'
        this.$refs.modalImportForm.initModal(importExcelUrl, templateUrl, templateName);
        this.$refs.modalImportForm.title = "返修出库导入";
      },
    }
  }
</script>
