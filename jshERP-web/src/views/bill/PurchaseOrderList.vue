    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(1)>-1" type="primary" icon="download" @click="handleExportXls('采购订单')">导出</a-button>
          <a-dropdown>
            <a-menu slot="overlay">
              ...
              <a-menu-item key="4" v-if="checkFlag && btnEnableList.indexOf('d')>-1" @click="batchSetStatus(2)"><a-icon type="check"/>强制完成</a-menu-item>
            </a-menu>
            <a-button>
        ...
        <div>
          <a-table
            ...
            <span slot="action" slot-scope="text, record">
              <a @click="myHandleDetail(record, '采购订单', prefixNo, true)">查看</a>
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/depotHead/exportPurchaseOrderExcel"
        }
      }
    },
    created() {
