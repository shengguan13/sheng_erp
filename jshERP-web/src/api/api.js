...
const addDepotAllocation = (params)=>postAction("/depotAllocation/add",params);
const editDepotAllocation = (params)=>putAction("/depotAllocation/update",params);
//商品属性
...
const getMaterialPickByBarCodeAndAmount = (params)=>getAction("/material/getMaterialPickByBarCodeAndAmount",params);
...
export {
  ...
  getMaterialPickByBarCodeAndAmount,
