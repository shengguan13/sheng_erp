            ...
            <a-row :gutter="24">
              <a-col :md="12" :sm="24">
                <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="供应商">
                  <a-input ref="name" placeholder="请输入供应商" v-model="queryParam.name"></a-input>
                </a-form-item>
              </a-col>
...
<script>
  ...
  import { getProductSupplierList } from '@/api/api'
    ...
    methods: {
      ...
      onSearch() {
        if(this.dataSource && this.dataSource.length===1) {
          if(this.queryParam.name === this.dataSource[0].supplierName) {
            let arr = []
